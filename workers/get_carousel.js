...
try {
  const output = execSync('npx wrangler d1 execute mytaxbot_linkedin --remote --json --command="SELECT media_base64 FROM posts WHERE id = \'43418c12-7003-4c59-b095-cb1810820050\'"').toString();
